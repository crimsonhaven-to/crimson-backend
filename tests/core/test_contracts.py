...
Covers that the builders validate against the JSON Schema, that the committed
schema file matches the generated one, and that the app imports and produces an
OpenAPI document (a smoke test for the whole route layer).
"""
...
def test_meta_line_allows_movie_nulls(validator):
    # The movie /watch path sends null season, episode and anilist id.
